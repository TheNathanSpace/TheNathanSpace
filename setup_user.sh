...
sudo apt update 
sudo apt upgrade -y 
sudo apt install -y vim openssh-server curl avahi-daemon avahi-utils git ack cifs-utils tree jq rsync sshfs fuse3 python3 python3-pip python-is-python3
